...
function HeadBar({ setOpen, ipoChange,isRegister }: IHeadBar) {
  ...
  const levelHtml = () => {
    ...
    return <img width={22} className=' mr-3' src={Icon} alt="" />
  }
        ...
        <div className=' relative flex items-center justify-center  cursor-pointer'>

          {
            account ? <span className='ring-1 ring-black rounded-full px-2 py-1 inline-flex whitespace-nowrap items-center justify-center mr-3'  >
              ...
              :
              <span className='ring-1 ring-black rounded-full px-2 py-1 inline-flex whitespace-nowrap items-center justify-center mr-3' onClick={() => { connectWallet() }}>
